...
CUSTOM_REPOSITORY_URL = 'https://raw.githubusercontent.com/planetlabs/qgis-planet-plugin' \
...
def test_plugin_repository_content():
    ...
    assert plugin.find('homepage').text == 'https://developers.planet.com/docs/integrations/qgis/'
    assert plugin.find('repository').text == 'https://github.com/planetlabs/qgis-planet-plugin'
    assert plugin.find('tracker').text == 'https://github.com/planetlabs/qgis-planet-plugin/issues'
